SELECT * FROM (
    SELECT
        neighborhood_name,
        num_bus_stops_accessible::integer AS num_bus_stops_accessible,
        num_bus_stops_inaccessible::integer AS num_bus_stops_inaccessible,
        ROUND(
    ...
    ORDER BY accessibility_metric ASC, num_bus_stops_inaccessible DESC
    LIMIT 5
) AS bottom5;
